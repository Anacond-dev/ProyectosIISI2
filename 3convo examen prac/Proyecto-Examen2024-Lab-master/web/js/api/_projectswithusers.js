...
const projectswithusersAPI_auto = {

    /** Gets all entries from 'projectswithusers' */
    getAll: async function() {
        let response = await axios.get(`${BASE_URL}/projectswithusers`, requestOptions);
        return response.data;
    },
};

export { projectswithusersAPI_auto };